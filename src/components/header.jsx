        ...
        <div className="flex items-center gap-4">
          ...
          {user ? (
            <div className="hidden sm:block relative" ref={dropdownRef}>
              ...
              >
                <div className="w-10 h-10 rounded-full overflow-hidden flex items-center justify-center text-gray-900">
                  {user?.photo ? (
                    <img
                      src={user.photo}
                      alt={user?.name || 'User'}
                      ...
                      onError={(e) => {
                        ...
                        e.target.parentElement.innerHTML += '<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>';
                      }}
                    />
                  ) : (
                    <User size={20} />
                ...
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-xl border border-gray-200 py-2 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                  ...
                  <div className="px-4 py-3 border-b border-gray-100">
                    <div className="flex items-center gap-3">
                      <div className="w-12 h-12 rounded-full overflow-hidden flex items-center justify-center text-white bg-gray-400">
                        {user?.photo ? (
                          <img
                            src={user.photo}
                            alt={user?.name || 'User'}
