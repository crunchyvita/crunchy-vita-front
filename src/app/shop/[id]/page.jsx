...
export default function ProductDetailPage() {
  ...
  const freshImg = productImages?.[2] || productImages?.[0] || '/placeholder.svg?height=500&width=1200';
  const lyoImg = productImages?.[3] || productImages?.[1] || freshImg || '/placeholder.svg?height=500&width=1200';
