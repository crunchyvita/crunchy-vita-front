      ...
      >
        {busy ? (
          ...
          <svg
            ...
            aria-hidden="true"
          >
            <path d="M788.1 340.9c-5.4 4.2-100.4 57-100.4 176.2 0 137.9 121.1 186.8 124.8 188 0 3-19.2 65.8-63.4 129.9-39.5 56.5-80.8 113-143.6 113-62.8 0-79-36.5-151.6-36.5-70.8 0-90.6 37.7-153.4 37.7-62.8 0-106.5-51-152.5-115.1C95.1 758.6 0 641.6 0 530.5 0 352.1 115.9 257.6 229.9 257.6c60.9 0 111.7 39.5 150.3 39.5 36.5 0 93.3-42 162.9-42 26.5 0 121.7 2.4 179 85.8zM572.6 86.4C601.3 51.1 621.4 2.4 621.4 0c0-1.8-.6-3.6-.6-3.6-46.7 1.8-102.2 31.1-135.7 70.6-26.3 30.5-50.9 79.3-50.9 128.8 0 2.4.6 4.8.6 5.4 3 .6 7.8 1.2 12.5 1.2 42 0 94.5-28.1 125.9-66.4z" />
          </svg>
        )}
        {t('payment.applePay')}
      </button>
