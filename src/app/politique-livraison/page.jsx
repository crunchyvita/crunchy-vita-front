  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 lg:px-8 py-16 w-full">
        <h1 className="text-5xl font-bold text-slate-900 mb-16">Politique de Livraison</h1>

        {/* Préparation et expédition */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-slate-900 mb-4">Préparation et expédition</h2>
        ...
        {/* En cas d'absence */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-slate-900 mb-4">En cas d'absence</h2>
          <p className="text-slate-700 leading-relaxed mb-4">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-slate-900 mb-4">Absence d'informations ou coordonnées incomplètes</h2>
          <p className="text-slate-700 leading-relaxed mb-4">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-slate-900 mb-4">Problèmes de livraison</h2>
          <p className="text-slate-700 leading-relaxed mb-4">
