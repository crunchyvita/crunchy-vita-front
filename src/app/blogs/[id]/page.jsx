      ...
      <div className="min-h-screen bg-white">
        <div className="container mx-auto px-6 py-12">
          ...
          <article className="max-w-4xl mx-auto">
            {/* Title */}
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 uppercase leading-tight text-center">
              {blog.title}
            </h1>
            ...
            <div className="prose prose-lg max-w-none">
              <div className="text-gray-700 leading-relaxed whitespace-pre-wrap font-serif text-lg">
                {blog.content.split('\n\n').map((paragraph, idx) => {
                  ...
                  if (isHeading && idx > 0) {
                    return (
                      <h2 key={idx} className="text-2xl md:text-3xl font-bold text-gray-900 uppercase my-8 py-4 border-b-2 border-gray-200">
                        {paragraph}
                      </h2>
                    );
                  }
