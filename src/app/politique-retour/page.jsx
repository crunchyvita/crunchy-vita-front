  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 lg:px-8 py-16 w-full">
        <h1 className="text-5xl font-bold text-slate-900 mb-16">Politique de Retour</h1>

        {/* Retour */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-slate-900 mb-4">Retour</h2>
        ...
        {/* Procédure de retour */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-slate-900 mb-4">Procédure de retour</h2>
          <p className="text-slate-700 leading-relaxed mb-4">
          ...
          <div className="space-y-6 mb-8">
            <div>
              <h3 className="font-bold text-slate-900 mb-2">1. Contacter le service client par email à contact@crunchyvita.com</h3>
            ...
            <div>
              <h3 className="font-bold text-slate-900 mb-2">2. Préparer les produits concernés</h3>
              <p className="text-slate-700 leading-relaxed ml-4">
            ...
            <div>
              <h3 className="font-bold text-slate-900 mb-2">3. Retourner le colis à l'adresse suivante :</h3>
        ...
        {/* Remboursement */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-slate-900 mb-4">Remboursement</h2>
          <p className="text-slate-700 leading-relaxed mb-4">
