  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 lg:px-8 py-16 w-full">
        <h1 className="text-5xl font-bold text-slate-900 mb-8">Politique de Confidentialité</h1>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-slate-900 mb-4">Informations personnelles recueillies</h2>
        ...
        {/* Cookies utilisés */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-slate-900 mb-6">Cookies utilisés</h2>
          
          <div className="space-y-6">
            {/* Cookies strictement nécessaires */}
            <div>
              <h3 className="text-xl font-bold text-slate-900 mb-3">1. Cookies strictement nécessaires</h3>
            ...
            {/* Cookies techniques */}
            <div>
              <h3 className="text-xl font-bold text-slate-900 mb-3">2. Cookies techniques</h3>
              <p className="text-slate-700 leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-bold text-slate-900 mb-3">3. Cookies de mesure d'audience</h3>
              <p className="text-slate-700 leading-relaxed">
            ...
            {/* Cookies marketing */}
            <div>
              <h3 className="text-xl font-bold text-slate-900 mb-3">4. Cookies marketing</h3>
              <p className="text-slate-700 leading-relaxed">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-slate-900 mb-4">Gestion et paramétrage des cookies</h2>
          <p className="text-slate-700 leading-relaxed mb-4">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-slate-900 mb-4">Utilisation des informations personnelles</h2>
          <p className="text-slate-700 leading-relaxed mb-4">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-slate-900 mb-4">Partage des informations personnelles</h2>
          <p className="text-slate-700 leading-relaxed mb-4">
